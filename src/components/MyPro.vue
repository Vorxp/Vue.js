      ...
      <div class="col-md-10 ">
        <div class="container">
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button
                ...
                id="aboutme-tab"
                data-bs-toggle="tab"
                data-bs-target="#aboutme-tab-pane"
                type="button"
                role="tab"
                aria-controls="aboutme-tab-pane"
                aria-selected="true"
              >
                ABOUT ME
              </button>
            ...
            <li class="nav-item" role="presentation">
              <button
                ...
                id="educate-tab"
                data-bs-toggle="tab"
                data-bs-target="#educate-tab-pane"
                type="button"
                role="tab"
                aria-controls="educate-tab-pane"
                aria-selected="false"
              >
                EDUCATION
              </button>
            ...
            <li class="nav-item" role="presentation">
              <button
                ...
                id="hobbie-tab"
                data-bs-toggle="tab"
                data-bs-target="#hobbie-tab-pane"
                type="button"
                role="tab"
                aria-controls="hobbie-tab-pane"
                aria-selected="false"
                hobbie
              >
                HOBBIES
          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
              <p>
                <b>ชื่อ</b> : นายวรพล บุญราศรี <br>
                <b>ชื่อเล่น</b> : กาย <br>
                <b>เกิดวันที่</b> 7 มิถุนายน พ.ศ. 2546 <br>
                <b>อายุ</b> 21 ปี <br>
                <b>สัญชาติ</b> ไทย <br>
                <b>เชื้อชาติ</b> ไทย <br>
                <b>ศาสนา</b> พุทธ <br>
                <b>กรุ๊ปเลือด</b> B <br>
                <b>น้ำหนัก</b> 48 กิโลกรัม <br>
                <b>ส่วนสูง</b> 164 เซนติเมตร 
              </p>
            </div>
            <div
              class="tab-pane fade"
              id="educate-tab-pane"
              role="tabpanel"
              aria-labelledby="educate-tab"
              tabindex="0"
            >
              <p>
                เบญจมราชรังสฤษฎิ์ <br>
                <img src="./ben_logo.png" height="250px" > <br>
                ปีการศึกษาที่จบ : 2564
              </p>
            </div>
            <div
              class="tab-pane fade"
